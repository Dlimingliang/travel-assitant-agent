...
| **第4天** | ReAct循环设计 | 1. 定义ReAct状态机（Thought、Action、Observation、Final Answer）<br>2. 实现思维链（Chain of Thought）提示模板<br>3. 编写ReAct主循环逻辑（解析LLM输出，决定下一步）<br>4. 添加简单的记忆管理（对话历史缓存） | 开发中  |
